...
**JDK包含JRE，JRE包含JVM。**
![图集/image-20230722101520786.png](图集/image-20230722101520786.png)
...
![图集/image-20230722105152051.png](图集/image-20230722105152051.png)
...
![图集/image-20230526195150761.png](图集/image-20230526195150761.png)
...
![[图集/Pasted image 20230809125002.png]]
...
![[图集/image-20230722171034441.png]]
在**jdk7**中，常量池的位置**在堆中**，此时，**常量池存储的就是引用了**。

![[图集/image-20230722171011916.png]]
...
![[图集/image-20230320155851990.png]]
...
？与 T的第一个区别：不关心List里面的元素，或者只需要用到List里面元素的最顶层父元素的方法的时候，可以用List< ?>来简化代码的书写。

？与 T的第二个区别：两者都可以通过extends来限定一个类型的子集，但是 T 可以 `List<T extends Number & ExtendInterface>` 即限定为多重继承的，？ 却不可以
...
3. 获取Method对象
![[图集/image-20230722222225057.png]]
...
![[图集/image-20230722222150068.png]]
...
![[图集/image-20230320185053941.png]]
...
![[图集/image-20230723102728094.png]]
...
![[图集/image-20230723104609410.png]]
...
![[图集/image-20230723123657439.png]]
